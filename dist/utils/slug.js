 ...
 */
export function buildIntakeSlug(projectName) {
 ...
 */
export async function resolveIntakeSlug(baseSlug, intakeDir) {
    ...
    while (true) {
        ...
        if (!(await fileExists(`${intakeDir}/${candidate}.md`)))
            return candidate;
        n++;
    }
}
 ...
 */
export function buildDispatchSlug(alias, context) {
 ...
 */
export async function resolveDispatchSlug(baseSlug, tasksDir) {
